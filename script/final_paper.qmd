...
In using R, this data work was made possible thanks to the following resource packages: {rio} [@rio], {here} [@here], {tidyverse} [@tidyverse], {tidylog} [@tidylog], {janitor} [@janitor], {skimr} [@skimr], {knitr} [@xie; @xieb; @xiec], and {kableExtra} [@kableextra].
